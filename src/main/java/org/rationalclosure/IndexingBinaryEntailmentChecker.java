...
public class IndexingBinaryEntailmentChecker {
            ...
            if (right > left) {
                ...
                // antecdent is entailed.
                    ...
                    if (classicalReasoner.query(combine(Arrays.copyOfRange(rankedKB, mid, rankedKB.length)),
                        ...
                        System.out.println(
                                "We\'ve found the rank from which we need to remove the above ranks! It's rank "
                                        + Integer.toString(mid));
                        antecedentNegationRanksToRemoveFrom.put(negationOfAntecedent, mid);
